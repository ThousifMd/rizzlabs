...
export default function DatingPlatformsSectionColor1() {
    const platforms = [
        { name: "Tinder", logo: "🔥" },
        { name: "Bumble", logo: "🐝" },
        { name: "Hinge", logo: "💕" },
        ...
        <div className="py-16 bg-black/50 backdrop-blur-sm border-y border-white/10">
            <div className="max-w-7xl mx-auto px-4">
                <div className="text-center mb-12">
                    ...
                    <h3 className="text-2xl font-bold bg-gradient-to-r from-[#d4ae36] via-[#c19d2f] to-[#d4ae36] bg-clip-text text-transparent mb-2 tracking-wider">
