                ...
                <div className="bg-white rounded-[2rem] h-full overflow-hidden relative">
                    ...
                    <div className="relative h-full">
                        ...
                        <div className="absolute bottom-4 left-4 right-4">
                            <div className="bg-black/60 backdrop-blur-md rounded-2xl p-4 shadow-lg">
                                {/* Profile Info */}
                                <div className="mb-3">
                                ...
                                <div className="flex items-center justify-center gap-4">
                                    {/* Reject Button */}
                                    <button className="w-12 h-12 bg-gray-600 rounded-full flex items-center justify-center hover:bg-gray-500 transition-all">
                                    ...
                                    {/* Like Button */}
                                    <button className="w-12 h-12 bg-[#FFD447] rounded-full flex items-center justify-center hover:bg-[#FFE066] transition-all">
        ...
        <section className="py-20 px-4 max-w-7xl mx-auto">
            <div className="text-center mb-16">
                ...
                <p className="text-xl text-white max-w-2xl mx-auto">
                    See how profiles transform inside Tinder/Bumble/Hinge-style cards (names blurred).
                </p>
            </div>
